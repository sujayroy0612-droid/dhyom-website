    ...
    <div className="min-h-screen">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 bg-damson overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to bottom, rgba(61,20,40,0.82) 0%, rgba(61,20,40,0.48) 28%, rgba(61,20,40,0.42) 50%, rgba(61,20,40,0.50) 72%, rgba(61,20,40,0.82) 100%)",
          }}
        />
        <div
          aria-hidden="true"
      ...
      {reviews.length > 0 && (
        <section className="bg-ink py-24 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Heading */}
            <FadeInView className="text-center mb-16">
              <p className="font-display text-[0.56rem] tracking-[0.30em] uppercase text-[rgba(196,163,115,0.45)] mb-4">
                Real Reviews
              </p>
              <h2
                className="font-display text-ivory"
              ...
              <div className="mt-5 mx-auto w-12 h-px bg-[rgba(196,163,115,0.35)]" />
              <p className="mt-5 font-body font-light italic text-[rgba(245,237,224,0.35)] text-[0.88rem]">
                Verified purchases · As seen on Amazon
              </p>
            </FadeInView>
