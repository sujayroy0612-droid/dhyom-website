...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  // Marketing area provides its own layout/sidebar — pass through after auth
      ...
      <aside className="fixed top-0 left-0 h-full w-52 bg-[#1a0a12] border-r border-[rgba(196,163,115,0.10)] flex flex-col z-40">
        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-0.5 overflow-y-auto">
          ...
          <Link
            ...
            className={[
              "mt-2 flex items-center gap-3 px-3 py-2.5 rounded-[4px] transition-all duration-150",
          ...
          >
            ...
            <span className="font-display text-[0.52rem] tracking-[0.14em] uppercase flex-1">
              Marketing
            </span>
            <span className="text-[0.55rem] opacity-35">→</span>
          </Link>
        </nav>
