...
const SUBCATEGORY_NAMES: Record<string, string> = {
  ...
  ganesha: "Ganesha",
  lakshmi: "Lakshmi",
  navagraha: "Navagraha Collection",
  diwali: "Diwali",
  rakhi: "Rakhi",
  chhath: "Chhath Puja",
...
const SUBCATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  navagraha: "Nine sacred stones, each aligned to a ruling planet. Worn close to the skin, they carry the frequency of their Graha. Find yours through your Mulank — the numerology of your birth day.",
...
const VALID_PARAMS = [
  ...
  { category: "bracelet",          subcategory: "navagraha" },
...
export default async function SubcategoryPage({ params }: PageProps) {
  ...
  const cols =
    "id,slug,name,type,subcategory,collection,fragrance,price,description,short_description,image_url,category,stock,created_at";
