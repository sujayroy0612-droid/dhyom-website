...
export default function DownsellPage() {
  ...
  useEffect(() => {
    async function load() {
      const { data: o, error: oErr } = await supabase
        .from("orders")
        .select("order_number,first_name,last_name,customer_name,email,phone,address,shipping_street,shipping_city,shipping_state,shipping_pincode,items,payment_method")
  ...
  function handleDecline() {
    if (order) router.push(`/order-confirmation/${order.order_number}`);
  }
      ...
      <div className="pt-24 pb-20 max-w-xl mx-auto px-6">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-5 font-body font-light italic text-[rgba(245,237,224,0.42)] text-base leading-[1.85]">
            Perhaps this smaller piece belongs alongside it.
          </p>
        </div>
